module Beaker
  ...
  class Perf
    ...
    PERF_SUPPORTED_PLATFORMS = /debian|ubuntu|redhat|centos|oracle|scientific|fedora|(rh)?el|eos|cumulus|sles/
    PERF_START_PLATFORMS     = /debian|ubuntu|redhat|centos|oracle|scientific|fedora|(rh)?el|eos|cumulus/
    ...
    def setup_perf_on_host(host)
      ...
      if @options[:collect_perf_data] =~ /aggressive/
        ...
        elsif host['platform'] =~ /centos|(rh)?el|fedora|oracle|redhats|scientific/
