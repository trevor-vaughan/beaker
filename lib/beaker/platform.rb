module Beaker
  ...
  class Platform < String
    # Supported platforms
    PLATFORMS = /^(huaweios|cisco_nexus|cisco_ios_xr|(free|open)bsd|osx|centos|fedora|debian|oracle|redhat|scientific|sles|ubuntu|windows|solaris|aix|archlinux|(rh)?el|eos|cumulus|f5|netscaler)\-.+\-.+$/
